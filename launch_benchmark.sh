...
function main {
    ...
    do
        # pre run
        python main.py --device $device --model convnext_base --eval true \
            --resume https://dl.fbaipublicfiles.com/convnext/convnext_base_22k_1k_224.pth \
            --input_size 224 --drop_path 0.2 --data_set dummy \
            --batch_size 1 \
...
function generate_core_launcher {
    ...
    do
        ...
        printf "python -m oob-common.launch --enable_jemalloc \
            ...
            main.py --device $device --model convnext_base --eval true \
                --resume https://dl.fbaipublicfiles.com/convnext/convnext_base_22k_1k_224.pth \
                --input_size 224 --drop_path 0.2 --data_set dummy \
                --batch_size $batch_size \
                --num_iter $num_iter --num_warmup $num_warmup \
